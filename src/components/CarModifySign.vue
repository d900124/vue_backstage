  ...
  <div class="col-10">
      ...
      <table class="table">
        ...
        <tbody class="table-group-divider">
          ...
          <tr v-for="carData in carDatas" :key="carData.id" :carData="carData">
            ...
            <td class="table-td">
              {{ carData.cainfoBrand }} - {{ carData.carinfoModelName }}
            </td>
            ...
            <el-button
              type="danger"
              style="background-color: #a33238; color: white"
              @click="changeId(carData.id)"
              round
              >修改</el-button
            >
          </tr>
    ...
    <div class="btm-div" style="display: flex" @click="toggleCarInsert">
      <font-awesome-icon
        icon="plus"
        size="xl"
        style="color: #a33238; padding: 13 5 0 5"
      />
      <el-button type="" link class="text-btm" style="color: #a33238"
        >新增車輛</el-button
      >
    </div>
...
const goBack = () => {
  ...
  router.push({ name: "car-maintain-link" }).then(() => {
